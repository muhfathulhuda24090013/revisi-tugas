...
export const ScheduleCard = ({ topic, date, time, location, svgIcon, aosDelay }: ScheduleCardProps) => {
  return (
    <div data-aos="fade-up" data-aos-delay={aosDelay} className="p-8 bg-white border-b-4 sm:border-b-0 box-content sm:box-border sm:border-r-4 w-full max-w-lg border-invofest rounded-xl flex flex-col sm:flex-row gap-5 mx-5">
